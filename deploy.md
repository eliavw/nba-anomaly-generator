...
```bash
git remote add origin git@github.com:eliavw/nba-anomaly-generator.git
git remote -v
...
```bash
git remote add origin git@github.com:eliavw/nba-anomaly-generator.git; git remote -v; git push origin master
```
...
```bash
conda env create -f dependencies-deploy.yaml -n nba-anomaly-generator
```
...
conda env update -n nba-anomaly-generator -f dependencies-develop.yaml
```
...
```bash
conda activate nba-anomaly-generator
python -m ipykernel install --user --name nba-anomaly-generator --display-name "nba-anomaly-generator"
```
...
1. Go to the [Travis](https://travis-ci.com/eliavw/nba-anomaly-generator) page of this repo.
2. See if it ran.
...
and your site should be online at; [https://eliavw.github.io/nba-anomaly-generator/](https://eliavw.github.io/nba-anomaly-generator/). 
...
> Generate semi-artificial anomaly detection datasets, starting from NBA data., cf. https://eliavw.github.io/nba-anomaly-generator
